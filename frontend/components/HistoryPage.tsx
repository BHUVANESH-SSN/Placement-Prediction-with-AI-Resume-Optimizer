      ...
      <nav className="home-nav">
        ...
        <button
          ...
          style={{
            ...
            fontSize: 13, fontFamily: "'Fira Code', sans-serif",
        ...
        <div className="profile-card fade-in-up fade-in-up-delay-2" style={{ opacity: 0 }}>
            ...
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center" }}>
              <button
                ...
                style={{
                  ...
                  fontSize: 12, fontFamily: "'Fira Code', sans-serif", fontWeight: 700,
          ...
          {loading && (
            <div style={{
              ...
              color: "var(--muted)", fontFamily: "'Fira Code', sans-serif",
            }}>
          ...
          {!loading && !error && displayed.length === 0 && (
            <div style={{
              ...
              color: "var(--muted)", fontFamily: "'Fira Code', sans-serif", textAlign: "center",
            }}>
              <FileText size={44} opacity={0.3} />
