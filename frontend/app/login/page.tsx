    ...
    <AuthLayout>
      <div className="w-full">
        <div className="fade-in-up">
          <h1 className="heading" style={{ fontSize: 'clamp(32px, 4vw, 46px)', marginTop: 0, marginBottom: 16 }}>
            Welcome <span className="heading-accent">Back</span>
          </h1>
          <p className="sub-text text-[15.5px]" style={{ marginBottom: 40, lineHeight: 1.65 }}>Log in to your account and continue your journey.</p>
        </div>
